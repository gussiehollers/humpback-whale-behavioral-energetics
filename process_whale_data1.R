...
prh_file<-"C:/Users/Gussie/Documents/humpback-whale-behavioral-energetics/humpback PRHs/mn200219-55 10Hzprh.mat"

process_whale_data1 <- function(prh_file, size_file, sample_rate, chunk_size) {
  
  # Load the PRH file
  prh=readMat(prh_file, maxLength=NULL, fixNames=TRUE, verbose=FALSE)
  ...
  #get rid of the conditional statement for now
  #ifelse(prh$speed$JJr2 > prh$speed$FNr2, prh$speed$JJ, prh$speed$FN)

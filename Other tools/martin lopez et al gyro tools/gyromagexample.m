...
fs=10;      % sampling rate of the data in Hz
fc=0.4*0.25;    % filter cut-off frequency in Hz - about 0.4 x fluking rate
...
subplot(211),plot(saMag),grid
subplot(212),plot(saGyro),grid
